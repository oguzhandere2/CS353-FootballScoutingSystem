                    ...
                    <div class="row">
                        <div class="col-md-3" style="">
                            ...
                            <div class="btn-group btn-group-vertical m-2">
                                ...
                                <a href="agent_display_footballers.php" class="btn m-2 btn-dark py-4">Display my footballers</a>
                                <a href="agent_add_footballer.php" class="btn m-2 btn-dark py-4">Add a footballer</a>
