    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group"> <input type="text" name= "agency_set_username" class="form-control"> </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group"> <input type="password" name= "agency_set_password" class="form-control"> </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <h4 class="" contenteditable="false">Region:</h4>
        </div>
        <div class="col-md-6">
         
            <div class="form-group"> <input type="text" name= "agency_set_region" class="form-control"> </div>
