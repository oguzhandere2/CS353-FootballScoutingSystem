                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="breadcrumb m-1 shadow-none bg-dark" style="">
                                ...
                                <li class="breadcrumb-item"><a href="club_players.php" class="text-light">Players</a></li>
                                <li class="breadcrumb-item"><a href="club_transfers.php" class="text-light">Transfers</a></li>
                                <li class="breadcrumb-item"><a href="organizations.php" class="text-light">Organizations</a></li>
                                <li class="breadcrumb-item"><a href="club_tasks.php" class="text-light">Tasks</a></li>
                                <li class="breadcrumb-item"><a href="club_reports.php" class="text-light">Reports</a></li>
                                <li class="breadcrumb-item"><a href="club_settings.php" class="text-light">Settings</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3" style="">
                            ...
                            <div class="btn-group btn-group-vertical m-2">
                                <a href="club_makenewoffer.php" class="btn m-2 btn-dark py-4">Make a New Offer</a>
                                <a href="club_sendtask.php" class="btn m-2 btn-dark py-4">Create a New Task</a>
                                <a href="club_compare_footballers.php" class="btn m-2 btn-dark py-4">Compare Footballers</a>
