    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 py-2">
          <h1 class="display-4 py-0 text-white" >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;FOOTBALLERS</h1>
        </div>
      </div>
    </div>
  </div>
            ...
            <table class="table">
              ...
              <tbody class="text-white">
                  <?php
                    ...
                    $result = mysqli_query($db, "select * from footballer where agent_user_id = '$userid' ") or die("Unable to access" . mysqli_error());
                    ...
                    while ($row = mysqli_fetch_assoc($result)) 
                    {
                      ...
                      if ($club_user_id != NULL)
                      {
                      $result2 = mysqli_query($db, "select * from user where id = '$club_user_id' ") or die("Unable to access" . mysqli_error());
                      $row2 = mysqli_fetch_assoc($result2);
                      $club_name = $row2['name'];
                      echo "<tr><td>$footballer_name</td><td>$club_name</td><td>$contract</td><td>$position</td></tr>";
                      }
                      
                      else 
                      {
                          echo "<tr><td>$footballer_name</td><td>Club is not in system</td><td>$contract</td><td>$position</td></tr>";
                      }
